...
# vvsrc
  ...
  ####
  # characterset change
#  iconv -f utf-8 -t gbk report/$tem/vv_src_416_$tem.csv > report/$tem/vvsrc416_$tem.csv
#  rm report/$tem/vv_src416_$tem.csv
########

########
# pv
#sh src/getPV.sh /data/dev/tangye/ott/logs/data/$tem/pv_$tem /data/dev/xiaofei/pv/pv_keys.txt $tem
